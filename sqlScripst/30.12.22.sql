  ...
  CREATE TABLE IF NOT EXISTS `MC_products`.`VylepseniProduktu` (
    ...
    INDEX `fk_VylepseniProduktu_Produkty1_idx` (`produkt` ASC),
    CONSTRAINT `fk_VylepseniProduktu_Vylepseni1`
      FOREIGN KEY (`vylepseni`)
      REFERENCES `MC_products`.`Vylepseni` (`id`)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION,
    CONSTRAINT `fk_VylepseniProduktu_Produkty1`
      FOREIGN KEY (`produkt`)
  ...
  CREATE TABLE IF NOT EXISTS `MC_products`.`VylepseniProKetegorie` (
    ...
    INDEX `fk_VylepseniProKetegorie_Kategorie1_idx` (`kategorie` ASC),
    CONSTRAINT `fk_VylepseniProKetegorie_Vylepseni1`
      FOREIGN KEY (`vylepseni`)
      REFERENCES `MC_products`.`Vylepseni` (`id`)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION,
    CONSTRAINT `fk_VylepseniProKetegorie_Kategorie1`
      FOREIGN KEY (`kategorie`)
      REFERENCES `MC_products`.`Kategorie` (`id`)
      ON DELETE NO ACTION
      ON UPDATE NO ACTION)
